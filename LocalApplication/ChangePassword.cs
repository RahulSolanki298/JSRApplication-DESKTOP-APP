...
namespace LocalApplication
{
    public partial class ChangePassword : Form
    {
        ...
        public ChangePassword(CompanyEmployee companyEmployee)
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (var connection = DBHelper.GetConnection())
            {
                ...
                try
                {
                    ...
                    // Insert customer
                    using (var cmdInsertCustomer = new SqlCommand("Update CompanyEmployee set Password=@Password where Id=@Id", connection, transaction))
                    {
