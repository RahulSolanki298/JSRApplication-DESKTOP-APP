...
namespace LocalApplication
{
    public partial class Dashboard : Form
    {
        ...
        public Dashboard(CompanyEmployee employee)
        {
            InitializeComponent();
            ...
            using (var connection = DBHelper.GetConnection())
            {
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        manufacurer = dt.Rows[0]["ManufacturerName"].ToString();
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var worksheet = excelPackage.Workbook.Worksheets.Add("EL-Report");
                    ...
                    worksheet.Cells["M1:N2"].Merge = true;
                    worksheet.Cells["M1:N2"].Value = "";
                    ...
                    worksheet.Cells["J3:K3"].Value = manufacurer;

                    worksheet.Cells["l3"].Value = "Testing Date";

                    worksheet.Cells["m3:N3"].Merge = true;
                    worksheet.Cells["m3:N3"].Value = Convert.ToDateTime(testingDate).ToString("d");
